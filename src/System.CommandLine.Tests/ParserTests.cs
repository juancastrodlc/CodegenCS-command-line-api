    ...
    public partial class ParserTests
    {
        ...
        public void When_command_arguments_are_fewer_than_minimum_arity_then_an_error_is_returned()
        {
            ...
            result.Errors
                  .Select(e => e.Message)
                  .Should()
                  .Contain(LocalizationResources.Instance.RequiredArgumentMissing(result.CommandResult, default));
        }
        ...
        public void When_option_arguments_are_fewer_than_minimum_arity_then_an_error_is_returned()
        {
            ...
            result.Errors
                  .Select(e => e.Message)
                  .Should()
                  .Contain(LocalizationResources.Instance.RequiredArgumentMissing(result.CommandResult.FindResultFor(option),default));
        }
